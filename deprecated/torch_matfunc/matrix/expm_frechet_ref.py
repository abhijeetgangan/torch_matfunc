# ruff: noqa: E741, F841, E712
"""
Reference implementation of matrix exponential and its Fréchet derivative.
Taken from https://github.com/cetmann/pytorch_expm
"""
...
def _compute_scales(A):
    ...
    if A.dtype == torch.float64:
        ...
        if A.requires_grad:
            ell = {3: 0.308033041845330, 5: 1.482532614793145, 7: 3.248671755200478}
        else:
            ell = {3: 0.425873001692283, 5: 1.880152677804762, 7: 3.925724783138660}
        if max_norm >= ell[5]:
            m = 7
            magic_number = ell[m]
            s = torch.relu_(torch.ceil(torch.log2_(norm / magic_number)))
